            ...
            <div className="my-6 flex justify-between items-center">
                <div className="flex-1">
                    <div className="flex flex-col justify-center gap-6">
                        <h1 className="text-xl font-thin">Ingredients :</h1>
                        <ul className="text-xl ml-12">
                            {
                                ingredients &&
                                ingredients.map((i, idx) => (<li key={idx} className="list-disc">{i}</li>))
                            }
                        </ul>
                        ...
                        <ul className="text-xl ml-12">
                            {
                                nutrition_info && 
                                Object.keys(nutrition_info).map((n, idx) => (<li key={idx} className="list-disc">{n} : {nutrition_info[n]}</li>))
                            }
                        </ul>
                    </div>
                </div>
